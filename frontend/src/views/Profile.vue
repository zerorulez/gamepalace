        ...
        <div class="col-12 offset-lg-2 col-lg-8">
          <div class="form">
            ...
            <form @submit.prevent="update()" class="container">
              ...
              <div class="form-group text-left">
                <label for="user">Usuário</label>
                <input type="text" v-model="user.username" class="form-control" name="username" id="username" disabled>
              </div>
              <div class="form-group text-left">
              ...
              <div class="form-group text-left">
                ...
                <textarea class="form-control" v-model="user.about" id="about" name="about" rows="3"></textarea>
              </div>
              <!-- <div class="form-group text-left">
  ...
  methods: {
    ...
    update() {
      ...
      if (!this.errors.length) {
        ...
        axios.put(process.env.VUE_APP_API + '/profile', { about: this.user.about }, { headers }).then( res => {
          this.sucess = true
          this.user = res.data
        }).catch( err => {
